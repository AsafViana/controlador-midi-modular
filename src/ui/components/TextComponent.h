 ...
 *
 * Renderiza uma string na posição (x, y) com tamanho de fonte e cor
 * configuráveis. Trunca automaticamente o texto que ultrapassaria a largura do
 * display (128px). Trata text == nullptr como string vazia.
 */
...
public:
   ...
   */
  TextComponent(int16_t x, int16_t y, const char *text, uint8_t fontSize = 1,
...
private:
  ...
  static constexpr int16_t MAX_DISPLAY_WIDTH = 128;
};
